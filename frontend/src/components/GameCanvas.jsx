      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 text-xs font-mono">
          <div className="flex items-center gap-1 text-[var(--accent-color)]">
            <span className="font-bold">{t("moodLabel").toUpperCase()}:</span>{" "}
            {dream.blueprint.mood}
          </div>
          <div className="flex items-center gap-1 text-[var(--secondary-color)]">
            <span className="font-bold">{t("heroLabel").toUpperCase()}:</span>{" "}
            {dream.blueprint.hero}
          </div>
        </div>
      </div>
                  ...
                  {gameState === "win" && !scoreSubmitted && (
                    ...
                    >
                      ...
                      {isSubmittingScore
                        ...
                        : t("postScoreToLeaderboard").toUpperCase()}
                    </button>
                  )}
