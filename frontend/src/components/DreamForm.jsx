...
export default function DreamForm({ onSubmit, isGenerating }) {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: compilationLogs is derived from i18n.language and isGenerating; including it directly causes stale closure
  useEffect(() => {
    if (isGenerating) {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: compilationLogs entries are derived from i18n.language; adding the array would break the sequential log effect
  useEffect(() => {
