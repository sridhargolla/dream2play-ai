const PROVIDER_DEFAULTS = {
  ...
  anthropic: { model: 'claude-3-haiku-20240307', endpoint: 'https://api.anthropic.com' },
  gemini: { model: 'gemini-1.5-flash', endpoint: 'https://generativelanguage.googleapis.com' }
};
...
export function getAISettings() {
  ...
  const endpoint = localStorage.getItem('dream2play_ai_endpoint') || defaultEndpoint;
