...
import { AlertCircle, Gamepad2, Lock, Mail, ShieldCheck, Sparkles, User, Wand2 } from 'lucide-react';
  ...
  return (
    <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center py-12 px-4">
      <div className="lg:col-span-7 flex flex-col gap-6 text-left">
        ...
        <p className="text-gray-400 text-sm md:text-base leading-relaxed max-w-xl font-medium">{t('heroCopy')}</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
          ...
          <div className="glass-panel p-4 rounded-xl flex items-start gap-3 border border-white/5 bg-white/5">
            ...
            <div>
              ...
              <p className="text-[10px] text-gray-400 mt-0.5">{t('gameStarted')}</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            {!isLogin && (
              <div className="flex flex-col gap-1.5">
                <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">{t('username')}</label>
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">{t('email')}</label>
              <div className="relative">
