...
export default function SettingsPage() {
  ...
  const [darkMode, setDarkMode] = useState(
    localStorage.getItem("dream2play_dark_mode") !== "false",
  );
  const [notifications, setNotifications] = useState(
    localStorage.getItem("dream2play_notifications") !== "false",
  );
    ...
    <div className="w-full max-w-4xl mx-auto py-8 px-4 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <label className="flex flex-col gap-2">
              ...
              >
                ...
                <option value="ollama" className="bg-slate-950 text-white">
                  {t("provider_ollama", "Ollama (Local)")}
                </option>
                <option value="local" className="bg-slate-950 text-white">
                  {t("provider_local", "Local OpenAI Compatible")}
                </option>
                <option value="anthropic" className="bg-slate-950 text-white">
                  {t("provider_anthropic", "Anthropic Claude")}
                </option>
                <option value="gemini" className="bg-slate-950 text-white">
                  {t("provider_gemini", "Google Gemini")}
                </option>
              </select>
            </label>
      ...
      <div className="glass-panel rounded-2xl p-6 flex flex-col gap-5 border border-white/5">
        ...
        >
          ...
          <span
            className={`h-6 w-11 rounded-full p-1 transition-all ${
              darkMode ? "bg-[var(--accent-color)]" : "bg-gray-700"
            }`}
          >
            <span
        ...
        >
          ...
          <span
            className={`h-6 w-11 rounded-full p-1 transition-all ${
              notifications ? "bg-[var(--accent-color)]" : "bg-gray-700"
            }`}
          >
            <span
              className={`block h-4 w-4 rounded-full bg-white transition-transform duration-350 ${
